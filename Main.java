            ...
            switch (scanner.nextLine().toLowerCase()) {
                ...
                case "3":
                    ...
                    while (true) {
                        try {
                            ...
                            cinema.addMovie(new Movie(title, duration, genre));
                            break;
                        } catch (DateTimeParseException dtp) {
                ...
                case "4":
                    ...
                    while (true) {
                        try {
                            ...
                            cinema.addSeance(new Seance(new Movie(title, duration, genre), start), day);
                            break;
                ...
                case "5":
                    ...
                    while (true) {
                        try {
                            duration = new Time(parse(scanner.nextLine()));
                            cinema.removeMovie(new Movie(title, duration, genre));
                            break;
                        } catch (DateTimeParseException dtp) {
                            out.println("Incorrect time data, enter again (hh:mm):");
                        }
                ...
                case "6":
                    ...
                    while (true) {
                        try {
                            out.println("Enter a day of the seance (SUNDAY, MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY)");
                            day = scanner.nextLine();
                            cinema.removeSeance(new Seance(new Movie(title, duration, genre), start), day);
                            break;
                        } catch (IllegalArgumentException e) {
                            out.println("Incorrect day of week");
                        }
