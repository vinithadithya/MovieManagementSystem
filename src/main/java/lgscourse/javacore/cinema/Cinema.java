...
public class Cinema implements Serializable {
    ...
    private TreeMap<lgscourse.javacore.cinema.Days, Schedule> schedules;
    ...
    public Cinema() {
        ...
        for (lgscourse.javacore.cinema.Days day : lgscourse.javacore.cinema.Days.values()) {
    ...
    public TreeMap<lgscourse.javacore.cinema.Days, Schedule> getSchedules() {
        return schedules;
    }
    ...
    public void addSeance(Seance seance, String day) {
        lgscourse.javacore.cinema.Days _day = lgscourse.javacore.cinema.Days.valueOf(day.toUpperCase());
    ...
    private boolean checkTime(Seance seance, lgscourse.javacore.cinema.Days _day) {
    ...
    public void removeSeance(Seance seance, String day) {
        try {
            schedules.get(lgscourse.javacore.cinema.Days.valueOf(day.toUpperCase())).removeSeance(seance);
